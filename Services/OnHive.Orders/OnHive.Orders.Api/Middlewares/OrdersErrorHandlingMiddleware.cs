...
namespace OnHive.Orders.Api.Middlewares
{
    public class ErrorHandlingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            {
                Log.Logger.Warning("Product not found: {message}", ex.Message, ex);
            ...
            {
                Log.Logger.Warning("Invalid status: {message}", ex.Message, ex);
