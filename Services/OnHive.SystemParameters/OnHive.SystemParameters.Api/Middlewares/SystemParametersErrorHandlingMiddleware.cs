...
namespace OnHive.SystemParameters.Api.Middlewares
{
    public class ErrorHandlingMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            catch (UnauthorizedAccessException ex)
            {
                ...
                var result = JsonSerializer.Serialize(Response<SystemParameter>.Unauthorized(ex.Message));
            ...
            catch (Exception ex)
            {
                ...
                var result = JsonSerializer.Serialize(Response<SystemParameter>.Error(ex.Message));
                var writer = context.Response.BodyWriter;
                await writer.WriteAsync(System.Text.Encoding.UTF8.GetBytes(result));
                await writer.CompleteAsync();
            }
